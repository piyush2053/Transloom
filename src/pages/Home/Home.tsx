...
const Home = () => {
  ...
  return (
    <div className='fade-in mt-20'>
      ...
      <Tooltip title="Click here to discover what we do and what are out purpose for this Transloom Project" >
        <div className="fixed bottom-8 right-8">
          <Link to="/about" className="bg-[#424242] hover:bg-[#9400EF] text-white font-bold py-2 px-7 rounded-full">
            About Us
          </Link>
        </div>
      </Tooltip>
